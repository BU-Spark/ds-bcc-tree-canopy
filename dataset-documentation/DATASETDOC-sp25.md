...
* What is the link to your project’s GitHub repository?
  ...
  [Github](https://github.com/BU-Spark/ds-bcc-tree-canopy)  
* What is the link to your project’s Google Drive folder? \*\**This should be a Spark\! Owned Google Drive folder \- please contact your PM if you do not have access\*\**<br>
  [Google Drive](https://drive.google.com/drive/folders/1B718VdWHsRmir2jxxE4EMXRKt5ThdJ7w?usp=drive_link)
* In your own words, what is this project about? What is the goal of this project?   

  This project, developed in partnership with Councilor Ben Weber, investigates the distribution of Boston’s tree canopy to assess differences between City of Boston owned trees and privately owned trees. Using a geospatial and data-driven approach, we aim to uncover patterns in canopy distribution, identify disparities across neighborhoods and land use types, and inform urban forestry strategies and environmental justice efforts. <br>

  The goal of this project is to understand how much of Boston's tree canopy is currently protected by the tree ordinance passed in 2023 to advocate for extending the ordinance to more tree canopy in Boston. 
...
[Link to Github Dataset Folder](https://github.com/BU-Spark/ds-bcc-tree-canopy/tree/dev/datasets)
...
[Data Dictionary](https://data.boston.gov/dataset/canopy-change-assessment-data-dictionary)
* What keywords or tags would you attach to the data set?  
  * Domain(s) of Application: Geospatial Mapping/Analysis, potential for Text Classification in next steps.
...
The dataset consists of LIDAR scans of Boston's tree canopy to support accountability for the Urban Forestry Plan. The goal of the plan is to ... The LIDAR scans are to be taken every five years in order to reach their 20__ goal. Analysis was done by the University of Vermont to aggregate tree canopy by land use and neighborhood to manage tree canopy loss and gain periodically. There was a gap in knowledge of how much of Boston's tree canopy degrades or grows over time, which the LIDAR scans help provide data on how well the Urban Forest Plan is achieving its goals. 
...
For the Tree Canopy Metrics and Tree Canopy Change Metrics datasets, each instance depends on the layer you select. Data can be aggregated by census tract, neighborhood, land use, parcel, and city wards.

For the Tree Canopy Polygons dataset, each instance represents a polygon of area that is covered by tree canopy. 

For the Citywide Land Audit, each instance represents a parcel of land owned by the City of Boston. 

* How many instances are there in total (of each type, if appropriate)?  

For Tree Canopy Metrics aggreated by parcels, there were 173,875 parcels of land, including one instance that represents all right-of-way areas. 
...
The datasets contain a comprehensive view of all areas in Boston.
